...
class PersonData: NSObject {
    ...
    class func getSpekears() -> [Person] {
        ...
        speakers.append(Person(name: "Mauro André B. Mazzola", desc: "Atua como desenvolvedor iOS e Android", image: "mauro", bio:URL(string:"https://www.linkedin.com/in/mauro-andr%C3%A9-barros-mazzola-b02996a4/")))
        
        //speakers.append(Person(name: "Alan", desc: "", image: "", bio:URL(string:"")))
        
        return speakers
    }
    
    class func getByName(name: String) -> Person  {
        return getSpekears().filter{$0.name == name}.first ?? Person(name: "", desc: "", image: "", bio: nil)
    }
